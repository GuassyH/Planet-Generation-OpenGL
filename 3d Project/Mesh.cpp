...
Mesh::Mesh()
{
	std::cout << "Dont Construct Yet" << std::endl;
}



void Mesh::UpdateMesh(std::vector <Vertex>& vertices, std::vector <GLuint>& indices, std::vector <Texture>& textures)
{
	Mesh::vertices = vertices;
	Mesh::indices = indices;
	Mesh::textures = textures;
...
void Mesh::Draw(Shader& shader, Camera& camera)
{
	...
	glUniformMatrix4fv(glGetUniformLocation(shader.ID, "rotation"), 1, GL_FALSE, glm::value_ptr(rotMatrix));
